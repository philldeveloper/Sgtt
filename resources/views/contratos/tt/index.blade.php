...
@include('researcher.modals.modal_1')
@include('researcher.modals.modal_2')
@include('researcher.modals.modal_3')
@include('researcher.modals.modal_4')
@include('researcher.modals.modal_5')
@include('researcher.modals.modal_6')
