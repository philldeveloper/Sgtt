            ...
            <div class="container-fluid p-0 mt-0 m-0">
              <div class="text-justify text-black">
                ...
                <div class="form-group col-md-12">
                  <textarea class="form-control" name="clausula_descricao" placeholder="{{$contratos_sr->clausula_descricao}}" disabled=""></textarea>
                </div>
                ...
                <br><div class="form-group col-md-12"><textarea name="clausula_objetivo" class="form-control" placeholder="{{$contratos_sr->clausula_objetivo}}" disabled=""></textarea></div>
        ...
        <div class="tab-pane " id="clausula2" role="tabpanel" aria-labelledby="clausula2-tab">
            <div class="container-fluid p-0 mt-0 m-0">
              <div class="text-justify text-black">
                ...
                <p class="text-blue"><b>2.4 </b>Recaem sobre o Coordenador do Projeto<a href="#" data-toggle="modal" data-target="#modalExemplo14"><i class="fas fa-fw fa-question-circle"></i></a>, designado pela ICT nos termos da alínea c, item 3.1.1., as responsabilidades técnicas e de articulação correspondentes.</p>
