         ...
         <div class="tab-pane " id="clausula2" role="tabpanel" aria-labelledby="clausula2-tab">
            ...
            <div class="container-fluid p-0 mt-0 m-0">
              <div class="text-justify text-black">
                ...
                <div class="col-md-12 mb-3">
                  <textarea class="form-control font-weight-bold text-justify" name="clausula_edit_12" rows="8" style="background-color: #F6FAFA; resize: none !important;">A) Formulário de Resultado Parcial: anualmente, até o último dia útil do mês de dezembro de cada ano de vigência deste Acordo, em conformidade com os indicadores estabelecidos no respectivo Plano de Trabalho;<br>B) Formulário de Resultado Final: no prazo de até 120 (cento e vinte) dias contados da conclusão do objeto deste Acordo, em conformidade com os indicadores estabelecidos no respectivo Plano de Trabalho.<br>
                </textarea>
               </div>
