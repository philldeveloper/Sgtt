<div class="container-fluid p-0 mt-0 m-0">
    ...
    <h5 class="text-uppercase font-weight-bold roboto-font text-left text-black mb-3 bg-light p-2">2. CLÁUSULA SEGUNDA – DO PLANO DE TRABALHO </h5>
        ...
        <p class="">{!! $contratos_sr->clausula_edit_2_3 !!}</p>
        <p class="">{!! $contratos_sr->clausula_edit_2_4 !!}</p>
        <p class="">{!! $contratos_sr->clausula_edit_2_5 !!}</p>
        <p class="">{!! $contratos_sr->clausula_edit_2_6 !!}</p>
    </div>
</div>