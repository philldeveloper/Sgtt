<div class="container-fluid p-0 mt-0 m-0">
    ...
    <h4 class="text-uppercase font-weight-bold roboto-font text-left text-black mb-3 p-2">2. CLÁUSULA SEGUNDA – DO PLANO DE TRABALHO </h4><hr>
      ...
      <!-- <p class=""><b>2.2 </b>Respeitadas as previsões contidas na legislação em vigor, a(o) <input class="mb-2 text-black myform-control" value="{{$contratos_sr->nome_ict}}" type="text" disabled> <a href="#" data-toggle="modal" data-target="#modalExemplo13"><i class="fas fa-fw fa-question-circle"></i></a>, com a interveniência da FUNDAÇÃO DE APOIO, fomentará/executará as atividades de pesquisa e desenvolvimento, conforme o Plano de Trabalho, sob as condições aqui acordadas, sendo parte integrante e indissociável deste Acordo.</p>           -->
      <p class=""><b>2.2 </b>{!! $contratos_sr->clausula_edit_2_2 !!}</p>
      <p class=""><b>2.3 </b>{!! $contratos_sr->clausula_edit_2_3 !!}</p>
      <p class=""><b>2.4 </b>{!! $contratos_sr->clausula_edit_2_4 !!}</p>
      <p class=""><b>2.5 </b>{!! $contratos_sr->clausula_edit_2_5 !!}</p>
      <p class=""><b>2.6 </b>{!! $contratos_sr->clausula_edit_2_6 !!}</p>
    </div>
</div>