<div class="container-fluid p-0 mt-0 m-0">
    ...
    <h5 class="text-uppercase font-weight-bold roboto-font text-left text-black mb-3 bg-light p-2">10. CLÁUSULA DÉCIMA - DA VIGÊNCIA E DA PRORROGAÇÃO</h5>
        <p><b>10.1</b> O presente Acordo de Parceria para PD&I vigerá pelo prazo de <input class="myform-control text-black" type="text" name="prazo_vigencia" value="{{$contratos_sr->prazo_vigencia}}" disabled> anos, a partir da data de sua assinatura, prorrogáveis.</p>
