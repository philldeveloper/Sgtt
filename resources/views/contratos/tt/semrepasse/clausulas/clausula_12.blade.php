<div class="container-fluid p-0 mt-0 m-0">
    <div class="text-justify text-black">
        ...
        <p><b>12.2</b>  O pesquisador deverá encaminhar ao Setor responsável ou COMISSÃO DO(A) <input class="mb-2 text-black myform-control" name="nome_setor_comissao"  value="{{$contratos_sr->nome_setor_comissao}}" type="text" disabled></p>
