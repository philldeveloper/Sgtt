<div class="container-fluid p-0 mt-0 m-0">
    ...
    <p class="">{!! $contratos_sr->clausula_edit_13_2 !!}</p>
    <p class="">{!! $contratos_sr->clausula_edit_13_2_1 !!}</p>
    <p class="">{!! $contratos_sr->clausula_edit_13_2_2 !!}</p>
    <p class="">{!! $contratos_sr->clausula_edit_13_3 !!}</p>
