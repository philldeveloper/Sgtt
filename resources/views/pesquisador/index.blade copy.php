...
<div class="container-fluid mt-4">
  <ul class="nav nav-tabs mb-2" id="myTab" role="tablist">
    <li class="nav-item">
      <a class="nav-link mb-2 mr-1 active" id="cooperacao-tab" data-toggle="tab" href="#cooperacao" role="tab" aria-controls="cooperacao" aria-selected="true">
      <i class="fas fa-hands-helping float-left text-primary mr-2"></i>
      Acordo de Cooperação
    </a>
    </li>
    <li class="nav-item">
      <a class="nav-link mb-2 mr-1" id="tecnologia-tab" data-toggle="tab" href="#tecnologia" role="tab" aria-controls="tecnologia" aria-selected="false">
      <i class="fas fa-chalkboard-teacher float-left text-primary mr-2"></i>
      Transferência de Tecnologia
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link mb-2 mr-1" id="patentes-tab" data-toggle="tab" href="#patentes" role="tab" aria-controls="patentes" aria-selected="false">
        <i class="fas fa-chalkboard-teacher float-left text-primary mr-2"></i>
        Patentes
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link mb-2 mr-1" id="outros-tab" data-toggle="tab" href="#outros" role="tab" aria-controls="outros" aria-selected="false">
      <i class="fas fa-search-location float-left text-primary mr-2"></i>
