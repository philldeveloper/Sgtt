...
<div style="margin-top: 1.5cm !important; margin-left: 1.5cm !important; margin-right:1cm !important; margin-bottom: 1cm !important">
	<h1>{{$title}}</h1>
	<div style="justify-content: center; margin-bottom: 20px !important; text-align: center !important">
		<img src="{{asset('assets/brazao.jpg')}}" alt="" height="50px !important" />
	</div>
	...
	<br/><br/>
	<h4 style="text-align:justify !important; text-transform: uppercase !important">ACORDO DE COOPERAÇÃO TÉCNICA QUE ENTRE SI CELEBRAM {{$contrato->nome_ict}}, POR MEIO DO NÚCLEO DE INOVAÇÃO TECNOLÓGICA E {{$contrato->nome_parceiro}}, PARA FINS QUE ESPECIFICA.</h4>
	<br/><br/><br/>
...
<!-- <div style="line-height: 1.5em !important; text-align: justify !important">
	...
	<p><span style="margin-left: 32px !important">Os <b>PARCEIROS</b></span>, anteriormente qualificados, resolvem celebr/ar o presente Acordo de Parceria para Pesquisa, Desenvolvimento e Inovação - PD&I, em conformidade com as normas legais vigentes no Marco Legal de Ciência, Tecnologia e Inovação (Emenda Constitucional nº 85/15, Lei nº 10.973/2004, Lei nº 13.243/2016 e Decreto nº 9.283/2018), que deverá ser executado com estrita observância das seguintes cláusulas e condições:</p>
	...
	<p><span id="p-title">3.1</span>São responsabilidades e obr/igações, além dos outros compromissos assumidos neste Acordo de Parceria em PD&I:</p>
	...
	<p style="margin-left: 16px !important"><span style="margin-right: 8px !important">b)</span>Prestar ao(s) parceiro(s) informações sobr/e a situação de execução dos projetos, nos termos deste Acordo;</p>
	...
	<p style="margin-left: 16px !important"><span style="margin-right: 8px !important">b)</span>Prestar à ICT informações sobr/e os recursos recebidos e a respectiva situação de execução dos projetos aprovados, nos termos deste Acordo;</p>
	...
	<p><span id="p-title">7.4</span>Não haverá violação das obr/igações de CONFIDENCIALIDADE previstas no Acordo de Parceria nas seguintes hipóteses: </p>
	...
	<p><span id="p-title">7.4.3.</span>Informações técnicas ou comerciais que sejam recebidas de um terceiro que não esteja sob obr/igação de manter as informações técnicas ou comerciais em confidencialidade; </p>
	...
	<p><span id="p-title">11.1</span>As cláusulas e condições estabelecidas no presente instrumento poderão ser alteradas mediante celebr/ação de termo aditivo. </p>
	...
	<p><span id="p-title">13.4 O</span> presente Acordo será extinto com o cumprimento do objeto ou com o decurso de prazo de vigência. </p>
	...
	<br/>
		...
		<img src="{{asset('assets/sgtt_small.jpg')}}" alt="sgtt" width="60px" style="position: fixed; right:5px; bottom: 25px; opacity: 0.3; margin-top: 20px !important; margin-bottom: 20px !important"/>
</div>